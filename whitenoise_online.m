...
%     mu_k = mu./p;
    ...
    outputACset1 = [outputACset1 outputAC];
...
%         W = [W;W_kbins'];
    ...
    all_Y_Bm28c = [all_Y_Bm28c Y_Bm28c];
...
figure(1)
plot(1:n,outputACset1)

figure(2)
subplot(211)
plot(1:B,real(H_Bm28(1:B,1)));hold on
plot(1:B,real(estH_Bm28(1:B,1)));
subplot(212)
plot(1:B,real(H_Bm28(1:B,1)) - real(estH_Bm28(1:B,1)));
